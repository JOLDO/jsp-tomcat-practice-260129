...
public class TodoServiceTests_0226 {
    ...
    @Autowired
    TodoService_0226 todoService_0226;  //autowired보다는 생성자로 주입하는게 더 좋은 방식이지만

    @Test
    public void testRegister() {
        TodoDTO_0226 todoDTO_0226 = TodoDTO_0226.builder()
            .title("뭐!!2")
    ...
    public void testGetOne() {
        ...
        TodoDTO_0226 todoDTO = todoService_0226.getOne(32L);
        log.info(todoDTO);
    }

    @Test
    public void testDelete() {
        todoService_0226.remove(62L);
        log.info("출력 삭제완료");
    }
    ...
    public void testModify() {
        TodoDTO_0226 todoDTO_0226 = TodoDTO_0226.builder()
            ...
            .finished(false)
            .build();
        todoService_0226.modify(todoDTO_0226);
    }
    ...
    public void testPaging() {
        ...
        PageRequestDTO_0226 pageRequestDTO_0226 = PageRequestDTO_0226.builder()
            ...
            .size(10)
            .build();
        PageResponseDTO_0226<TodoDTO_0226> pageResponseDTO_0226 = todoService_0226.getList(pageRequestDTO_0226);
        //pageResponseDTO_0226에 페이징에 필요한 재료(10개씩 나눠진 데이터, 총 갯수, 시작 페이지 숫자, 끝 페이지 숫자
        //일단 페이징 처리가 된 10개 데이터만 출력
        pageResponseDTO_0226.getDtoList().forEach(todoDTO -> log.info("페이징된 데이터 출력 : " + todoDTO));
        log.info("total : " + pageResponseDTO_0226.getTotal());
        log.info("start : " + pageResponseDTO_0226.getStart());
        log.info("end : " + pageResponseDTO_0226.getEnd());
    }
}
