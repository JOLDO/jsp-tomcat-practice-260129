...
public class TodoMapperTests_0225 {
    @Autowired(required = false)
    //해당 객체를 활성화를 못하더라도 예외 발생 없이 null로 할당
    private TodoMapper_0225 todoMapper_0225;

    @Test
    public void testGetTime() {
        log.info("출력 - 시간 확인으로 마이바티스 임시 연결 확인 : " + todoMapper_0225.getTime());
    }

    @Test
    public void testInsert() {
        TodoVO_0225 todoVO_0225 = TodoVO_0225.builder()
            .title("뭐!!")
    ...
    public void testSelectAll() {
        List<TodoVO_0225> voList = todoMapper_0225.selectAll();
    ...
    public void testSelectOne() {
        ...
        TodoVO_0225 todoVO = todoMapper_0225.selectOne(32L);
        log.info(todoVO);
    }

    @Test
    public void testDelete() {
        todoMapper_0225.delete(63L);
    }
    ...
    public void testUpdate() {
        TodoVO_0225 todoVO_0225 = TodoVO_0225.builder()
            ...
            .finished(false)
            .build();
        todoMapper_0225.update(todoVO_0225);
    }
    ...
    public void testSelectListCount() {
        PageRequestDTO_0225 pageRequestDTO_0225 = PageRequestDTO_0225.builder()
                ...
                .size(10)
                .build();
        int resultCount = todoMapper_0225.getCount(pageRequestDTO_0225);
    ...
    public void testSelectSearch() {
        ...
        //전체 갯수
        log.info(todoMapper_0225.getCount(pageRequestDTO_0225));
    }
}
