...
import com.busanit501.jsp_server_project1.SPRING._0_260212.mapper.TimeMapper_0212;
...
public class TimeMapperTests_0212 {
    @Autowired(required = false)
    //해당 객체를 활성화를 못하더라도 예외 발생 없이 null로 할당
    private TimeMapper_0212 timeMapper_0212;

    @Test
    public void testGetTime() {
        log.info("출력 - 시간 확인으로 마이바티스 임시 연결 확인 : " + timeMapper_0212.getTime());
    }
}
