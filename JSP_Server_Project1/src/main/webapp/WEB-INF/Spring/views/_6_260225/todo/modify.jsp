            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="_6_260225/todo/modify" method="post" >
                        ...
                        <script>
                            ...
                            document.querySelector(".btn-secondary").addEventListener("click", function (e) {
                                    self.location = "/_6_260225/todo/list?${pageRequestDTO_0226.link}"
                                },false
                            )

                            //수정하기 -> form태그 내부의 액션 주소 : /_6_260225/todo/modify
                            document.querySelector(".btn-primary").addEventListener("click", function (e) {
                                const formModi = document.querySelector("form");
                                e.preventDefault();
                                e.stopPropagation();

                                formModi.action = "/_6_260225/todo/modify";
                                formModi.method = "post";
                                formModi.submit();
                                }, false
                            )
                            //삭제하기 버튼 클릭시 주소를 변경 /_6_260225/todo/delete, post로
                            document.querySelector(".btn-danger").addEventListener("click", function (e) {
                                ...
                                e.preventDefault(); ///_6_260225/todo/modify로 못가게 막음
                                ...
                                formObj.action = "/_6_260225/todo/delete";
                                formObj.method = "post";
                                formObj.submit();
                                },false
                            )
