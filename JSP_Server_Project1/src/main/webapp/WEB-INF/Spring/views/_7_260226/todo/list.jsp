...
<%--                                날짜는 해봤자 정해진 값이 출력되기에 그냥 $중괄호를 써서 넣는다--%>
                            ...
                            <script>
                                document.querySelector(".clearBtn").addEventListener("click", function (e) {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    self.location = "/_7_260226/todo/list"
                                })
                            </script>
                        </form>
                    </div>
...
<%--                            responseDTO안에 dtoList를 getter로 가져와 dto로 가지고 있음--%>
                            <c:forEach items="${responseDTO.dtoList}" var="dto">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/_7_260226/todo/read?tno=${dto.tno}&${pageRequestDTO_0226.link}" class="text-decoration-none">
...
<%--                            ul 태그 안에는 <li>태그와 <a>태그가 있음--%>
                            document.querySelector(".pagination").addEventListener("click", function(e) {
                                ...
                                <%--    url += "&types=${type}"--%>
                                <%--</c:forEach>--%>
                                <%--self.location = `/_7_260226/todo/list?page=\${num}\${url}&keyword=${pageRequestDTO_0226.keyword}&from=${pageRequestDTO_0226.from}&to=${pageRequestDTO_0226.to}`;--%>
