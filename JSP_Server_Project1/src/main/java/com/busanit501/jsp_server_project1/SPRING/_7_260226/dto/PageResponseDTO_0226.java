...
@Getter
@ToString
public class PageResponseDTO_0226<E> {
    private int page;
    private int size;
    ...
    public PageResponseDTO_0226(PageRequestDTO_0226 pageRequestDTO_0226, List<E> dtoList, int total) {
        this.page = pageRequestDTO_0226.getPage();
        this.size = pageRequestDTO_0226.getSize();
        this.pageSize = pageRequestDTO_0226.getPageSize();
        this.total = total;
