...
@Getter
@ToString
public class PageResponseDTO_0225<E> {
    private int page;
    private int size;
    ...
    public PageResponseDTO_0225(PageRequestDTO_0225 pageRequestDTO_0225, List<E> dtoList, int total) {
        this.page = pageRequestDTO_0225.getPage();
        this.size = pageRequestDTO_0225.getSize();
        this.pageSize = pageRequestDTO_0225.getPageSize();
        this.total = total;
