...
public class TodoController_BootStrap_0219 {
    ...
    //추가로 뷰 리졸버가 연결되어서 todo/list -> /WEB-INF/Spring/views/_2_260219/bootstrap/list.jsp
    public void list() {
...
//    @RequestMapping(value="/register", method = RequestMethod.GET)  //http://localhost:8080/_2_260219/bootstrap/register로 라우팅
    @GetMapping("/register")
    //추가로 뷰 리졸버가 연결되어서 todo/list -> /WEB-INF/Spring/views/_2_260219/bootstrap/register.jsp
