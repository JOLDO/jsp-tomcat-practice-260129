package com.busanit501.jsp_server_project1._7_260209._0209_todo.dao;

import com.busanit501.jsp_server_project1._7_260209._0209_todo.domain._0209_TodoVO;
import com.busanit501.jsp_server_project1._7_260209._0209_todo.util._0209_ConnectionUtil;
...
public class _0209_TodoDAO {
    ...
    public String getTime() {
        ...
        try(
                Connection connection = _0209_ConnectionUtil.INSTANCE.getConnection(); //DB서버에 연결하는 오구(DB서버 주소, 계정정보, 나머지 캐시옵션이 설정정된 객체)
    ...
    public void insert(_0209_TodoVO vo) throws Exception {
        //sql문 작성
    ...
    //목록 기능 구현
    public List<_0209_TodoVO> selectAll() throws Exception {
        //sql문 작성
        ...
        //임시로 담아둘 리스트 선언
        List<_0209_TodoVO> list = new ArrayList<>();
        ...
        while (resultSet.next()) {
            ...
            _0209_TodoVO vo = _0209_TodoVO.builder()
    ...
    public _0209_TodoVO selectOne(Long tno) throws Exception {
        //sql문 작성
    ...
    public void updateOne(_0209_TodoVO todoVo) throws Exception {
        //sql문 작성
