...
@Log4j2
@WebServlet(name = "_2_todoRegController_0209", urlPatterns = "/todo/register_0209")
public class _0209_2_TodoRegController extends HttpServlet {
    //1)화면 제공 2)글쓰기 작업 수행
...
//        //화면 응답
//        log.info("/todo/register_0209, 글작성 폼 임시화면 get으로 요청 처리함.");
//
...
//        //JSESSIONID와 loginInfo(명단)이 있을때 글쓰기 페이지로 이동
        req.getRequestDispatcher("/WEB-INF/_7_260209/_0209_todo/todoReg.jsp").forward(req, resp);
    }
