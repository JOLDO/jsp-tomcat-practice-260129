package com.busanit501.jsp_server_project1.Servlet._5_260205._0205_todo.dao;

import com.busanit501.jsp_server_project1.Servlet._5_260205._0205_todo.domain._0205_TodoVO;
import com.busanit501.jsp_server_project1.Servlet._5_260205._0205_todo.util._0205_ConnectionUtil;
...
public class _0205_TodoDAO {
    ...
    public String getTime() {
        ...
        try(
                Connection connection = _0205_ConnectionUtil.INSTANCE.getConnection(); //DB서버에 연결하는 오구(DB서버 주소, 계정정보, 나머지 캐시옵션이 설정정된 객체)
    ...
    public String getTime2() throws Exception {
        ...
        @Cleanup Connection connection = _0205_ConnectionUtil.INSTANCE.getConnection();
    ...
    public void insert(_0205_TodoVO vo) throws Exception {
        //sql문 작성
    ...
    //목록 기능 구현
    public List<_0205_TodoVO> selectAll() throws Exception {
        //sql문 작성
        ...
        //임시로 담아둘 리스트 선언
        List<_0205_TodoVO> list = new ArrayList<>();
        ...
        while (resultSet.next()) {
            ...
            _0205_TodoVO vo = _0205_TodoVO.builder()
    ...
    public _0205_TodoVO selectOne(Long tno) throws Exception {
        //sql문 작성
    ...
    public void updateOne(_0205_TodoVO todoVo) throws Exception {
        //sql문 작성
