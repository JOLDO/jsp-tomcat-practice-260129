...
@WebServlet(name = "_1_todoListController_0206", urlPatterns = "/todo/list_0206")
...
public class _0206_1_TodoListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            List<_0206_TodoDTO> dtoList = todoService.listAll();

            //서버에서 받아온 객체를 담아서 결과화면에 전달
            req.setAttribute("dtoList", dtoList);

            //결과화면으로 이동
            req.getRequestDispatcher("/WEB-INF/Servlet/_6_260206/_0206_todo/todoList.jsp")
                .forward(req, resp);
        } catch (Exception e) {
