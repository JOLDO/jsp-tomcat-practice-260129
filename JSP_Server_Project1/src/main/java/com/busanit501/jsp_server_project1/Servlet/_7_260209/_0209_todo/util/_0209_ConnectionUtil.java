package com.busanit501.jsp_server_project1.Servlet._7_260209._0209_todo.util;
...
@Log4j2
public enum _0209_ConnectionUtil {
    INSTANCE;   //enum이라서 final static으로 만들어짐

    private HikariDataSource ds;    //DB에 연결하는 도구

    _0209_ConnectionUtil() {    //생성자, enum도 클래스이기 때문에 생성자 만들수 있음
