package com.busanit501.jsp_server_project1.Servlet._2_260202._0202_todo.service;
...
public enum _0202_TodoService {
    ...
    //글쓰기
    public void register(_0202_TodoDTO _0202_todoDTO) {
        System.out.println("서비스 기능, 글쓰기 기능, " +
                "사용자가 일정을 입력하면, todoDTO 라는 객체에 담겨서, 전달을 받습니다." +
                "꺼내서 사용하면됩니다. 뼈대만 구성.");
        System.out.println("todoDTO : " + _0202_todoDTO);
    }

    //목록조회
    public List<_0202_TodoDTO> getList() {
        //10개의 샘플 등록
        List<_0202_TodoDTO> _0202_todoDTOS = IntStream.range(0, 10).mapToObj(i -> { //숫자가 0~9만큼 10개가 들어감
