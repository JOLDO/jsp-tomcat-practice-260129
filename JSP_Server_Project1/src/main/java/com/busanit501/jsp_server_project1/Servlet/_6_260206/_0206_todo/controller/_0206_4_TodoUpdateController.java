...
import com.busanit501.jsp_server_project1.Servlet._6_260206._0206_todo.dto._0206_TodoDTO;
...
@Log4j2
@WebServlet(name = "_5_todoUpdateController_0206", urlPatterns = "/todo/update_0206")
public class _0206_4_TodoUpdateController extends HttpServlet {
...
//        req.setCharacterEncoding("UTF-8");
        log.info("/todo/update_0206, 수정 폼 임시화면 get으로 요청 처리함. ");

        try {
            //상세조회에서 tno를 이미 불러왔고 tno를 이용해서 기존 데이터를 화면에 불러옴
            Long tno = Long.parseLong(req.getParameter("tno"));
            _0206_TodoDTO todoDTO = todoService.get(tno);

            //화면에 전달
            req.setAttribute("dto", todoDTO);
            req.getRequestDispatcher("/WEB-INF/Servlet/_6_260206/_0206_todo/todoUpdate.jsp").forward(req, resp);
